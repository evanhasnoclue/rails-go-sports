class Api::V1::SportsController < Api::V1::BaseController
  ...
  def sport_params
    params.require(:sport).permit(:title, :description, :category, :start_time, :end_time, :price, :photo, :province, :city, :district, :address, :capacity, :level, :user_id, :latitude, :longitude, :like, :real)
  end
